...
| Fase 10+ — Módulos futuros | Cada novo módulo/página a partir de um print anexado (Cadastros, Financeiro, Comunicação, Operações, Marketing, Configurações▸Geral) — sem API de backend hoje | um novo `docs/1N-<nome-do-modulo>.md` por módulo | ⏳ pendente |
